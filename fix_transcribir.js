...
fs.mkdirSync('app/api/transcribir', { recursive: true });
...
fs.writeFileSync('app/api/transcribir/route.js', content, 'utf8');
console.log('app/api/transcribir/route.js creado, longitud:', content.length);