...
fs.mkdirSync('app/diagnostico-supervisor', { recursive: true });
...
fs.writeFileSync('app/diagnostico-supervisor/page.js', content, 'utf8');
console.log('app/diagnostico-supervisor/page.js creado, longitud:', content.length);